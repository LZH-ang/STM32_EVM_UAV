...
#define SI24R1_SPI_RCC	RCC_APB2Periph_SPI1
#define SI24R1_SPI		SPI1
#define SI24R1_GPIOA 	GPIOA
#define SI24R1_GPIOB 	GPIOB
#define	SI24R1_MOSI		GPIO_Pin_7		// Master Out, Slave In pin (output)
#define	SI24R1_MISO  	GPIO_Pin_6    	// Master In, Slave Out pin (input)
#define	SI24R1_SCK     	GPIO_Pin_5    	// Serial Clock pin, (output)
#define	SI24R1_CSN     	GPIO_Pin_4    	// Slave Select pin, (output to CSN)
#define	SI24R1_CE    	GPIO_Pin_3    	// Chip Enable pin signal (output)
#define	SI24R1_IRQ    	GPIO_Pin_0   	// Interrupt signal, from nRF24L01 (input)
