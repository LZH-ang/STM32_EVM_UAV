...
#define MPU6050_I2C_APBxClock				RCC_APB1PeriphClockCmd
#define MPU6050_I2C_CLK						RCC_APB1Periph_I2C1
#define MPU6050_I2C_GPIO_APBxClock			RCC_APB2PeriphClockCmd
...
//#define MPU6050_I2C_INT_PORT				GPIOB 
...
#define		MPU6050_INT_PIN_CFG  	0x37	/* INT_LEVEL INT_OPEN LATCH_INT_EN INT_RD_CLEAR FSYNC_INT_LEVEL FSYNC_INT_EN I2C_BYPASS_EN */
#define		MPU6050_INT_ENABLE 		0x38	/* - MOT_EN - FIFO_OFLOW_EN I2C_MST_INT_EN - - DATA_RDY_EN*/
#define		MPU6050_INT_STATUS  	0x3A	/* - - - FIFO_OFLOW_INT I2C_MST_INT - - DATA_RDY_INT */
